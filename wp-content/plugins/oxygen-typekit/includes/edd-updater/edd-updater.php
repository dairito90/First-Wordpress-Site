...
Class OxygenTypekitUpdater { // class name should be unique for each add-on

	public $prefix 		= "edd_oxtk_"; // should be also unique for each add-on
	public $oxygen_url 	= "http://oxygenapp.com";
	public $addon_name 	= "Typekit"; // should be exact as EDD item name
	...
	function init() {
		...
		$edd_updater = new EDD_SL_Plugin_Updater( 
			$this->oxygen_url, 
			plugin_dir_path( dirname( dirname( __FILE__ ) ) ) . "oxygen-typekit.php", // main plugin file, specify for each add-on
			array( 
...
$updater = new OxygenTypekitUpdater();